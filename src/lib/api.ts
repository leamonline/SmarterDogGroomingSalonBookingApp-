...
async function fetchWithAuth(url: string, options: RequestInit = {}) {
  ...
  if (!response.ok) {
    ...
    const error = new Error(errorBody?.error || `API Request failed: ${response.statusText}`) as Error & {
...
export const api = {
  ...
  createStaff: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/staff", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateStaffRole: (userId: string, role: string) =>
    fetchWithAuth(`/api/staff/${userId}/role`, {
      method: "PUT",
  ...
  // Customers
  getCustomersPage: (page = 1, limit = 50) => fetchWithAuth(`/api/customers?page=${page}&limit=${limit}`),
  getCustomers: (page = 1, limit = 50) => fetchPaginatedData(`/api/customers?page=${page}&limit=${limit}`),
  getCustomer: (id: string) => fetchWithAuth(`/api/customers/${id}`),
  createCustomer: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/customers", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  lookupAppointmentClients: (params: {
    ownerName?: string;
    phone?: string;
    petName?: string;
    breed?: string;
  ...
  updateCustomer: (id: string, data: Record<string, unknown> | object) =>
  ...
  setCustomerTags: (customerId: string, tags: string[]) =>
    fetchWithAuth(`/api/customers/${customerId}/tags`, {
      method: "POST",
  ...
  setDogTags: (dogId: string, tags: string[]) =>
    fetchWithAuth(`/api/dogs/${dogId}/tags`, {
      method: "POST",
      body: JSON.stringify({ tags }),
    }),
  ...
  // Appointments
  getAppointments: (page = 1, limit = 50) => fetchPaginatedData(`/api/appointments?page=${page}&limit=${limit}`),
  ...
  createAppointment: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/appointments", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateAppointment: (id: string, data: Record<string, unknown> | object) =>
  ...
  // Services
  getServices: (page = 1, limit = 50) => fetchPaginatedData(`/api/services?page=${page}&limit=${limit}`),
  createService: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/services", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateService: (id: string, data: Record<string, unknown> | object) =>
  ...
  setServiceAddOns: (serviceId: string, addOnIds: string[]) =>
    fetchWithAuth(`/api/services/${serviceId}/add-ons`, {
      method: "POST",
  ...
  createAddOn: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/add-ons", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateAddOn: (id: string, data: Record<string, unknown> | object) =>
    fetchWithAuth(`/api/add-ons/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  ...
  getPayments: (appointmentId?: string) =>
    appointmentId ? fetchWithAuth(`/api/payments?appointmentId=${appointmentId}`) : fetchWithAuth("/api/payments"),
  createPayment: (data: Record<string, unknown> | object) =>
  ...
  createForm: (data: Record<string, unknown> | object) =>
    fetchWithAuth("/api/forms", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateForm: (id: string, data: Record<string, unknown> | object) =>
  ...
  submitForm: (data: Record<string, unknown> | object) =>
