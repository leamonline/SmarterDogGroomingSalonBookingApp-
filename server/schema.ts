...
const petSchema = z
  .object({
    ...
    vaccinations: z.array(z.object({
        ...
        expiryDate: z.string().max(500).optional().nullable(),
        status: z.string().max(500).optional().nullable(),
...
export const customerSchema = z
  .object({
    ...
    documents: z.array(z.object({
        ...
        uploadedAt: z.string().max(500).optional().nullable(),
...
export const appointmentSchema = z
  .object({
    ...
    surcharge: z.number().nonnegative().optional().nullable(),
